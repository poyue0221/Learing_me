...
parser.add_argument('-m', '--trained_model', default='./at5k_1/weights/mobilenet0.25_epoch_190.pth',
...
if __name__ == '__main__':
    ...
    net_prepared = torch.quantization.prepare(net_fused, inplace=True)
    net_prepared.eval()
    ...
    for i, img_name in enumerate(test_dataset):
        ...
        # b_loc, b_conf, loc, conf, v = net(img)
        _t['forward_pass'].toc()
        _t['misc'].tic()
