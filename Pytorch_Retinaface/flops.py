...
parser.add_argument('-m', '--trained_model', default='./weights/mobilenet0.25_quant.pth',
...
if __name__ == '__main__':
    ...
    a =torch.randn(1,3,480,270).to("cuda")
    print(a)
    # for a in train_loader:
    flops, params = profile(net, inputs=(a,), verbose=True)
