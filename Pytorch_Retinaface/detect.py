...
if __name__ == '__main__':
    ...
    # testing begin
    # for i in range(100):
    image_path = "/home/dwg/python-A/ObjectTracking/SiamCAR/tools/data_mp4/20201204_073918_197.avi"
    ...
    while True:
        ...
        # if not ret:
        #     continue
        image_path_ = sorted(glob.glob("./Test/原图片/*.jpg"))
        print(image_path_)
        for i in (image_path_):

            # image_path = "./curve/0_Parade_marchingband_1_5.jpg"
            img_raw = cv2.imread(i, cv2.IMREAD_COLOR)
            ...
            if args.save_image:
                for b in dets:
                    ...
                    # cv2.putText(img_raw, "fps=%d"%(FPS), (50, 50),
                ...
                name = "./Test/量化前图片/" + str(i.split("/")[-1][0:5])
                print(name)
                cv2.imwrite(name, img_raw)
                if i == './Test/原图片/9.jpg':
                    break
